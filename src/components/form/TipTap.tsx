...
import Iconify from '../Iconos/iconify'
...
interface MenuBarProps {
  ...
  mostrarOpcionesCodigo?: boolean
}

interface TipTapProps extends Omit<MenuBarProps, 'editor'> {
  editable: boolean
  contenido: string
  placeholder?: string
  ...
  const gruposOpciones = [
    ...
    mostrarOpcionesFormatoTexto && (
      <StyledToggleButtonGroup>
        ...
        >
          <Tooltip title="Negrita" placement="bottom-start">
        ...
        >
          <Tooltip title="Cursiva" placement="bottom-end">
            <Typography sx={{ display: 'flex' }} variant={'inherit'}>
              <Icono color={'inherit'} fontSize="medium">
                format_italic
              </Icono>
    ...
    mostrarOpcionesCodigo && (
      <StyledToggleButtonGroup>
        ...
        >
          <Tooltip title="Código" placement="bottom-start">
            <Typography sx={{ display: 'flex' }} variant={'inherit'}>
              <Icono color={'inherit'} fontSize="medium">
                code_icon
              </Icono>
        ...
        <Stack sx={{ pb: 1 }} direction={'row'} justifyContent={'flex-start'}>
          {editor && (
            <MenuBar
              ...
              mostrarOpcionesCodigo={mostrarOpcionesCodigo}
              editor={editor}
            />
          )}
        </Stack>
